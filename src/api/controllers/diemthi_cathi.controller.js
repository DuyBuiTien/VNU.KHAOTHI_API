...
exports.create = async (req, res, next) => {
    try {
        ...
        const item = await Diemthi_Cathis.create(itemData);
...
exports.update = async (req, res, next) => {
    try {
        const { Id } = req.params;
        let item = await Diemthi_Cathis.findByPk(Id);
...
exports.findAll = async (req, res, next) => {
    ...
    if (pagination === 'true') {
        Diemthi_Cathis.findAndCountAll({
            where: condition,
            limit,
            offset,
        })
