...
exports.create = async (req, res, next) => {
    try {
        ...
        const item = await Kythi_Monthis.create(itemData);
...
exports.update = async (req, res, next) => {
    try {
        const { Id } = req.params;
        let item = await Kythi_Monthis.findByPk(Id);
