...
exports.create = async (req, res, next) => {
    try {
        ...
        const item = await Kythi_Cathis.create(itemData);
...
exports.update = async (req, res, next) => {
    try {
        const { Id } = req.params;
        let item = await Kythi_Cathis.findByPk(Id);
