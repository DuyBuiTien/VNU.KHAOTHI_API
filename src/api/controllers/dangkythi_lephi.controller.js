...
exports.create = async (req, res, next) => {
    try {
        ...
        const item = await Dangkythi_Lephis.create(itemData);
...
exports.update = async (req, res, next) => {
    try {
        const { Id } = req.params;
        let item = await Dangkythi_Lephis.findByPk(Id);
...
exports.findAll = async (req, res, next) => {
    ...
    if (pagination === 'true') {
        Dangkythi_Lephis.findAndCountAll({
            where: condition,
            limit,
            offset,
        })
