...
exports.create = async (req, res, next) => {
    try {
        ...
        const item = await Student_Infos.create(itemData);
...
exports.update = async (req, res, next) => {
    try {
        const { Id } = req.params;
        let item = await Student_Infos.findByPk(Id);
